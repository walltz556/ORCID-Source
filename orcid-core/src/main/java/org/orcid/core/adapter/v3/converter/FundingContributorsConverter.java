...
public class FundingContributorsConverter extends BidirectionalConverter<FundingContributors, String> {
    ...
    @Override
    public String convertTo(FundingContributors source, Type<String> destinationType, MappingContext context) {
        return JsonUtils.convertToJsonString(source);
    }

    @Override
    public FundingContributors convertFrom(String source, Type<FundingContributors> destinationType, MappingContext context) {
