...
public class AdminControllerTest extends BaseControllerTest {
    ...
    protected Authentication getAuthentication() {
        ...
        OrcidProfileUserDetails details = new OrcidProfileUserDetails("4444-4444-4444-4440",
                "admin@user.com", null, roles);
        UsernamePasswordAuthenticationToken auth = new UsernamePasswordAuthenticationToken("4444-4444-4444-4440", details.getPassword(), roles);
    ...
    public void resetPasswordTest() throws IllegalAccessException {
        ProfileEntity p = profileEntityManagerReadOnly.findByOrcid("4444-4444-4444-4441");
        ...
        p = profileEntityManagerReadOnly.findByOrcid("4444-4444-4444-4441");
        assertNotEquals("e9adO9I4UpBwqI5tGR+qDodvAZ7mlcISn+T+kyqXPf2Z6PPevg7JijqYr6KGO8VOskOYqVOEK2FEDwebxWKGDrV/TQ9gRfKWZlzxssxsOnA=", p.getPassword());
    }

    @Test
    public void resetPasswordUsingEmailTest() throws IllegalAccessException {
        ProfileEntity p = profileEntityManagerReadOnly.findByOrcid("4444-4444-4444-4442");
        assertEquals("e9adO9I4UpBwqI5tGR+qDodvAZ7mlcISn+T+kyqXPf2Z6PPevg7JijqYr6KGO8VOskOYqVOEK2FEDwebxWKGDrV/TQ9gRfKWZlzxssxsOnA=", p.getPassword());
        AdminChangePassword form = new AdminChangePassword();
        form.setOrcidOrEmail("michael@bentine.com");
        form.setPassword("password1");
        adminController.resetPassword(mockRequest, mockResponse, form);
        p = profileEntityManagerReadOnly.findByOrcid("4444-4444-4444-4442");
        assertNotEquals("e9adO9I4UpBwqI5tGR+qDodvAZ7mlcISn+T+kyqXPf2Z6PPevg7JijqYr6KGO8VOskOYqVOEK2FEDwebxWKGDrV/TQ9gRfKWZlzxssxsOnA=", p.getPassword());
    }
